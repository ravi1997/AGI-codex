...
class MemoryConfig(BaseModel):
    ...
    episodic_db_path: Path = Field(
        Path("storage/episodic"), description="Location for episodic memory persistence."
    )
    semantic_db_path: Path = Field(
        Path("storage/semantic.db"), description="Location for semantic memory database file."
    )
