...
class SemanticMemory(MemoryStore):
    """Semantic knowledge base stored on disk."""
    ...
    def _load(self) -> None:
        ...
        LOGGER.info("Loaded %d semantic memories", len(self._records))
    ...
    def _persist(self) -> None:
        ...
        LOGGER.debug("Persisted %d semantic memories", len(self._records))
